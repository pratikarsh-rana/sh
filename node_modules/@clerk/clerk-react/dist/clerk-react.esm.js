...
var StructureContext = /*#__PURE__*/React.createContext(undefined);
StructureContext.displayName = 'StructureContext';

var IsomorphicClerkContext = /*#__PURE__*/React.createContext(undefined);
IsomorphicClerkContext.displayName = 'IsomorphicClerkContext';
var useClerk = function useClerk() {
  var structureCtx = useContext(StructureContext);
  var clerkCtx = useContext(IsomorphicClerkContext);
...
var withClerk = function withClerk(Component, displayName) {
  ...
  var HOC = function HOC(props) {
    ...
    if (clerk.client) {
      return React.createElement(StructureContext.Provider, {
...
var WithClerk = function WithClerk(_ref) {
  ...
  return React.createElement(StructureContext.Consumer, null, function (structureCtx) {
    return React.createElement(IsomorphicClerkContext.Consumer, null, function (clerkCtx) {
...
var ClientContext = /*#__PURE__*/React.createContext(undefined);
ClientContext.displayName = 'ClientContext';
function useSignIn() {
  var structureCtx = useContext(StructureContext);
  var clientCtx = React.useContext(ClientContext);
...
var SessionContext = /*#__PURE__*/React.createContext(undefined);
SessionContext.displayName = 'SessionContext';
function useSession() {
  var structureCtx = useContext(StructureContext);
  var sessionCtx = React.useContext(SessionContext);
...
var WithUser = function WithUser(_ref) {
  var children = _ref.children;
  return React.createElement(StructureContext.Consumer, null, function (structureCtx) {
    return React.createElement(UserContext.Consumer, null, function (userCtx) {
      if (typeof children !== 'function') {
        throw new Error(hocChildrenNotAFunctionError);
      }
...
function ClerkContextWrapper(_ref) {
  ...
  return React.createElement(IsomorphicClerkContext.Provider, {
    value: clerkCtx
...
function ClerkProviderBase(props) {
  ...
  }, clerk instanceof IsomorphicClerk && clerk.ssrData && React.createElement("script", {
    type: 'application/json',
    "data-clerk": 'SSR',
    dangerouslySetInnerHTML: {
      __html: clerk.ssrData
    }
  }), React.createElement(ClerkContextWrapper, {
...
var SignedOut = /*#__PURE__*/withClerk(function (_ref2) {
  ...
  var userCtx = useUserContext();
  return userCtx.value === null ? React.createElement(React.Fragment, null, children) : null;
}, 'SignedOut');
