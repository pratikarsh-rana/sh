...
var RestClient = /*#__PURE__*/function () {
  ...
  _proto.makeRequest = function makeRequest(requestOptions) {
    ...
    if (requestOptions.queryParams) {
      url = url + "?" + stringify(snakecaseKeys(requestOptions.queryParams));
    } // FIXME remove 'any'
...
export { Clerk, ClerkExpressRequireSession, ClerkExpressWithSession, ClerkServerError, Client, Email, EmailAddress, ExternalAccount, HttpError, IdentificationLink, Logger, PhoneNumber, SMSMessage, Session, User, Verification, clients, emails, requireSession, sessions, setClerkApiKey, setClerkApiVersion, setClerkHttpOptions, setClerkServerApiUrl, smsMessages, users, withSession };
//# sourceMappingURL=clerk-sdk-node.esm.js.map
