...
var Skeleton_ = __webpack_require__(6933);
...
// EXTERNAL MODULE: ./components/cards/TemplateCard.js
var TemplateCard = __webpack_require__(9632);
// EXTERNAL MODULE: ./components/SVGs.js
var SVGs = __webpack_require__(6043);
;// CONCATENATED MODULE: ./components/NoDocumentFound.js
...
const NoDocumentFound = ({
  ...
  className: "bg-primary flex flex-col items-center justify-center flex-1 col-span-full",
  children: [/*#__PURE__*/jsx_runtime_.jsx(SVGs/* NoFilesFoundSVG */.L0, {
    width: 200,
    height: 300
...
/* harmony default export */ var components_NoDocumentFound = (NoDocumentFound);
// EXTERNAL MODULE: ./shared/contants.js
var contants = __webpack_require__(1581);
...
const Dashboard = () => {
  ...
  const {
    id: userId
  } = (0,clerk_react_.useUser)(); // const { data: userInfo } = useClerkSWR('/api/loggedIn');
  ...
  const onDelete = async () => {
    try {
      showSnack(contants/* toastMessages.DELETE_RESOURCE_REQUEST */.t8.DELETE_RESOURCE_REQUEST('Resume'), 'default');
      await external_axios_default()({
        url: `/api/resumes/${selectedResume._id}`,
        method: 'DELETE'
      });
      setResumes(resumes => resumes.filter(resume => resume._id !== selectedResume._id));
      showSnack(contants/* toastMessages.DELETE_RESOURCE_SUCCESS */.t8.DELETE_RESOURCE_SUCCESS('Resume'), 'success');
    } catch (error) {
      // console.log('Error ', error);
      // console.log('Error Response: ', error.response);
      showSnack(contants/* toastMessages.DELETE_RESOURCE_ERROR */.t8.DELETE_RESOURCE_ERROR('Resume'), 'error');
    }
  };
  ...
  const render = () => {
    if (loading) {
      return Array.from(Array(4).keys()).map(loader => /*#__PURE__*/jsx_runtime_.jsx((Skeleton_default()), {
        className: "rounded",
        variant: "rect",
        width: "100%",
        height: 462
    ...
    if (error) {
      return /*#__PURE__*/jsx_runtime_.jsx(external_formik_.ErrorMessage, {
        error: error
      });
    }

    if (!resumes.length) {
      return /*#__PURE__*/jsx_runtime_.jsx(components_NoDocumentFound, {
        text: "No Resumes Found."
      });
    }

    return resumes.map(resume => /*#__PURE__*/jsx_runtime_.jsx(TemplateCard/* default */.Z, {
      template: resume,
      type: "RESUME",
      selected: resume._id === selectedResume._id,
      onSelect: onSelect
    }, resume._id));
  };
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
    ...
    children: [/*#__PURE__*/jsx_runtime_.jsx((head_default()), {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx("h2", {
        ...
        children: `${selectedResume ? `Selected Resume : ${selectedResume.title}` : 'Select a Resume'}`
      }), /*#__PURE__*/jsx_runtime_.jsx("h2", {
        className: "text-regular text-lg font-medium text-default",
        children: `${selectedResume && `Template : ${selectedResume.templateName}`}`
      }), /*#__PURE__*/jsx_runtime_.jsx("div", {
        className: "mt-6 lg:mt-0",
        children: selectedResume && /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
      ...
      className: "pt-10 px-10 xl:px-0 templates-grid-container",
      children: render()
    })]
  });
};
