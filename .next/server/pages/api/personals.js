...
/* harmony default export */ __webpack_exports__["default"] = ((0,_clerk_clerk_sdk_node__WEBPACK_IMPORTED_MODULE_0__.requireSession)(async (req, res) => {
  ...
  switch (method) {
    case 'POST':
      try {
        const personal = await _models_Personal__WEBPACK_IMPORTED_MODULE_1__/* .default.create */ .Z.create(_objectSpread(_objectSpread({}, body), {}, {
          userId: req.session.userId
        }));
        await _models_Resume__WEBPACK_IMPORTED_MODULE_2__/* .default.findByIdAndUpdate */ .Z.findByIdAndUpdate(body.resumeId, {
        ...
        if (!personal) {
          return res.status(400).json({
            success: false,
            error: 'Unable to create personal entry.'
          });
        }
...
var __webpack_exports__ = (__webpack_exec__(4209));
