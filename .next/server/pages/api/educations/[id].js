...
/* harmony default export */ __webpack_exports__["default"] = ((0,_clerk_clerk_sdk_node__WEBPACK_IMPORTED_MODULE_0__.requireSession)(async (req, res) => {
  ...
  switch (method) {
    case 'PUT':
      try {
        const education = await _models_Education__WEBPACK_IMPORTED_MODULE_1__/* .default.findOneAndUpdate */ .Z.findOneAndUpdate({
          _id: id,
        ...
        if (!education) {
          return res.status(400).json({
            success: false,
            error: 'Unable to edit educational data.'
          });
        }
    ...
    case 'DELETE':
      try {
        const education = await _models_Education__WEBPACK_IMPORTED_MODULE_1__/* .default.findById */ .Z.findById(id);
...
var __webpack_exports__ = (__webpack_exec__(2072));
