...
/* harmony default export */ __webpack_exports__["default"] = ((0,_clerk_clerk_sdk_node__WEBPACK_IMPORTED_MODULE_0__.requireSession)(async (req, res) => {
  ...
  switch (method) {
    case 'PUT':
      try {
        const extras = await _models_Extras__WEBPACK_IMPORTED_MODULE_1__/* .default.findOneAndUpdate */ .Z.findOneAndUpdate({
          _id: id,
        ...
        if (!extras) {
          return res.status(400).json({
            success: false,
            error: 'Unable to edit extras data.'
          });
        }
    ...
    case 'DELETE':
      try {
        const extras = await _models_Extras__WEBPACK_IMPORTED_MODULE_1__/* .default.findOne */ .Z.findOne({
          _id: id,
          userId: req.session.userId
        });
...
var __webpack_exports__ = (__webpack_exec__(9965));
