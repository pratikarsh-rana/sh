...
/* harmony default export */ __webpack_exports__["default"] = ((0,_clerk_clerk_sdk_node__WEBPACK_IMPORTED_MODULE_0__.requireSession)(async (req, res) => {
  ...
  switch (method) {
    case 'POST':
      try {
        const education = await _models_Education__WEBPACK_IMPORTED_MODULE_1__/* .default.create */ .Z.create(_objectSpread(_objectSpread({}, body), {}, {
        ...
        if (!education) {
          return res.status(400).json({
            success: false,
            error: 'Unable to create Educational data.'
          });
        }
